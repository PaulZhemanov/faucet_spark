			...
			switch (true) {
				case green:
					return css`
						...
						background: ${active ? colors.greenMedium : colors.greenDark};
				...
				case red:
					return css`
						...
						background: ${active ? colors.redMedium : colors.redDark};

						&:hover {
							background: ${colors.redMedium};
						}
				...
				default:
					return css`
						border: 1px solid ${active ? colors.borderAccent : colors.borderPrimary};
						color: ${active ? colors.textPrimary : colors.textSecondary};
